...
export default function Home() {
  ...
  const workCell = ({ title, desc, src, alt, rev, imgDivClass }: { title: string, desc: string, src: string, alt: string, rev: boolean, imgDivClass?: string }) => {
  ...
  return <>
    <Head>
      <title>SyncAI - Portland AI</title>
    ...
    <main>
      <div className="space-y-32">
        <div className="grid place-items-center text-center">
          <h1 className="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl">Introducing Sync<span className='text-main'>AI</span></h1>
          ...
          <div className="flex space-x-2 mt-4">
            ...
            <Link href={'#plus'}><p className='btn-main'>SyncAI+</p></Link>
          </div>
        </div>
        ...
        <div className="space-y-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            {typeCell({
              ...
              desc: "Do we not support a use case for you? Go ahead and try to tell the model what you are looking for!",
        ...
        <div id="plus" className="space-y-8">
          <div className="grid place-items-center">
            <div className="grid max-w-screen-xl px-4 py-8 mx-auto gap-4 lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
              <div className="mr-auto place-self-center lg:col-span-7">
                <h1 className="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl">SyncAI <span className='text-main'>Plus</span></h1>
                <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl">SyncAI plus takes the core idea the live demo employs and implements it at the next level. Using the next generation language model from OpenAI, GPT-4, vast amounts of information can be imported to create next-level personalized and tailored content.</p>
              </div>
          ...
          {workCell({
            title: "How It Works",
            desc: "First, you import vast amounts of information (text documents, pdfs, reports, spreadsheets) into a global knowledge-base. Then, PortlandAI's technolody creates a global index-based system to provide the model with the most relavent content from this knowledge-base.",
            src: "/svg/knowledge-base.svg",
            alt: "AI Knowledge Base",
            rev: true,
            imgDivClass: "max-w-[250px] md:max-w-[400px]",
          })}
          {workCell({
            title: "Interactive Chat Interface",
            desc: "With this knowledge-base created, SyncAI+ gives a familiar chat-bot interface to query and generate content from your all of your personalized imported content.",
            src: "/svg/chat.svg",
            alt: "AI Chat Bot",
            rev: false,
            imgDivClass: "max-w-[250px] md:max-w-[400px]",
          ...
          <div className="">
            <Form props={{
              nameLabel: "Name",
              emailLabel: "Email",
              bodyLabel: "I need a new knowledge accumulation tool, like notion or obsidian.",
              tag: "",
            }} />
          </div>
        </div>
